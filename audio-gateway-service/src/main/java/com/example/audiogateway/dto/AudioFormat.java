 ...
 *
 * <p>CLOSED enum — future addition requires ADR + Codex consensus.
 * Codex {@code 019e879c}+{@code 019e8846} agreed to prevent cardinality explosion in
 * {@code stt_audio_bytes_total{format=...}} downstream metric.
 */
