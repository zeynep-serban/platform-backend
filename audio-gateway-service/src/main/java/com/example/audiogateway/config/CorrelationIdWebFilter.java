 ...
 *
 * <p>If the client provides {@code X-Correlation-Id}, normalize (length-bounded) and pass
 * through. If absent or invalid, generate a fresh UUID4.
 *
 * <p>Downstream STT services receive the id via internal headers. Logs MUST include the id
 * under {@code correlation_id} key (observability-skeleton-meeting-intelligence.md).
 */
@Component
@Order(-100)
